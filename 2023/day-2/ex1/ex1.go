...
func is_game_possible(game [][]int) bool {
...
func parse_game_number(line string) int {
	string_sets := strings.Split(line, ": ")
	string_number := strings.Replace(string_sets[0], "Game ", "", 1)
...
func main() {
	...
	for scanner.Scan() {
		line := scanner.Text()
		var game_number = parse_game_number(line)
